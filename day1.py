...
print("27号      皮草          135.6     855         57")
print("28号      羽绒服        253.6     500         10")
print("29号      T恤           65.8      632         63")
print("30号      风衣          96.8      335         78")
print("12月销售总金额：%.2f"%(253.6*(10+69+140+10+10)+86.3*(60+72+35+90+60+60+140)+96.8*(43+25+43+60+43+78)+135.9*(63+24+63+57)+65.8*(63+45+129+63+58+48+63)+49.3*(120)))
print("羽绒服的销售占比:%.2f%%"%(253.6*(10+69+140+10+10)/198400.6*100))
print("牛仔裤的销售占比:%.2f%%"%(86.3*(60+72+35+90+60+60+140)/198400.6*100))
print("风衣的销售占比:%.2f%%"%(96.8*(43+25+43+60+43+78)/198400.6*100))
print("皮草的销售占比:%.2f%%"%(135.9*(63+24+63+57)/198400.6*100))
print("T恤的销售占比:%.2f%%"%(65.8*(63+45+129+63+58+48+63)/198400.6*100))
print("衬衫的销售占比:%.2f%%"%(49.3*120)/198400.6*100)